...
public class CustomerValidationRules {
	...
	public static String checkForDuplicateCustomer(Map<String,Customer> customerMap,String email)throws Customer_Exceptions {
	...
	public static Customer validateCustomer(Map<String,Customer> arrCustomer,String fname,String lname,String email,String password,String dob,String plan,double amnt) throws Customer_Exceptions
	{
