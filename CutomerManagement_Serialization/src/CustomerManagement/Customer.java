...
public class Customer implements Serializable/*implements Comparable<Customer>*/{
	...
	public Customer(String fname, String lname, String gmail, String pwd, LocalDate dateOfBirth, ServicePlan value,
	...
	public String toString() {
		return "Customer ID : " + customerId + "\tFirst Name : " + firstName + "\tLast Name : " + lastName
				+ "\tEmail : " + email + "\tPassword : " + password + "\tRegistration Amount : " + registrationAmount
				+ "\tDOB : " + dob + "\tPlans : " + plans + "\tregistrationAmount: " + registrationAmount;
	}
